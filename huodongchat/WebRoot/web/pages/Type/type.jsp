    ...
    $('#grid1').datagrid({
        ...
        columns: [
            [
                ...
                {title: '敏感词', width: 100, field: 'title', sortable: true}
            ]
        ], toolbar: [
            {
                text: '新增',
...
<div id="managerDialog" class="easyui-dialog" title="敏感词管理" style="width:350px;height:150px;" toolbar="#dlg-toolbar"
    ...
    <form id="managForm" name="managForm" method="post" enctype="multipart/form-data">
        ...
        <table cellpadding="1" cellspacing="1" class="tb_custom1">
            <tr>
                <th width="30%" align="right"><label>敏感词：</label></th>
                <td width="30%">
