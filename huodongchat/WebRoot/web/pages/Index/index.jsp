...
<head id="Head1">
    ...
    if(roletype == "1"){
    	_menus = {
   	         "menus": [
   	             {"menuid": "1", "icon": "icon-magic", "menuname": "用户评论管理",
   	                 "menus": [
   	                     {"menuid": "12", "menuname": "用户评论管理列表", "icon": "icon-database", "url": "<%= __APP__%>/Posts!posts"}
   	                 ]},
   	             {"menuid": "1", "icon": "icon-magic", "menuname": "敏感词管理",
   	                 "menus": [
   	                     {"menuid": "12", "menuname": "敏感词列表", "icon": "icon-database", "url": "<%= __APP__%>/Type!type"}
   	                 ]},
   	              {"menuid": "1", "icon": "icon-magic", "menuname": "消息管理",
   	                     "menus": [
   	                         {"menuid": "12", "menuname": "消息列表", "icon": "icon-database", "url": "<%= __APP__%>/Message!message"}
   	                     ]},
   	                 /*{"menuid": "1", "icon": "icon-magic", "menuname": "学校管理",
   	                     "menus": [
   	                         {"menuid": "12", "menuname": "学校列表", "icon": "icon-database", "url": "<%= __APP__%>/Shop!shop"}
   	                     ]},
